    ...
    <SectionLayout className="mt-30 bg-white p-2">
      ...
      <div className="max-w-6xl mx-auto grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 mb-24">
        {[
          {
            image_url:
              "https://img.antaranews.com/cache/1200x800/2020/06/01/Screenshot_20200601-082804_Instagram.jpg.webp",
            title: "Istri Adi yang imut",
          },
          {
            image_url:
              "https://www.attitude.co.uk/wp-content/uploads/sites/5/2018/03/fs_mag2.jpg",
            title: "2 Istri Thoriq yang lagi bermesra mesraan",
          },
          {
            image_url:
              "https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEjj0q2cmXdPOc_zOyYOt52g8NGcLV7LqqjM5JrhQuPPdyYT9HjFGe7JR2mNUs1vAfJmi_KQKzs7b-CyA14BnEGKvyT5tSvbzkR6sVfu_gehocOaxIiAktiPB-1oofJbffBybrKJ-qi4_i4/s1600/Lisa-BLACKPINK.png",
            title: "Istri Egik",
          },
        ].map((item, index) => (
          <div
